...
export default function GettingStarted()
{
    return (
        <>
            <title>Getting Started &#8729; React Starter</title>
            <meta name="description" content="Installation, setup, and running the React Starter project. Learn how to get started with this React boilerplate." />
            <meta name="keywords" content="React, Getting Started, Installation, Setup, Guide" />
            <meta property="og:title" content="Getting Started &#8729; React Starter" />
            <meta property="og:description" content="Installation and setup guide for React Starter." />
