...
export default function ProjectStructure()
{
    return (
        <>
            <title>Project Structure &#8729; React Starter</title>
            <meta name="description" content="Folder organization and architecture overview of the React Starter project using Atomic Design methodology." />
            <meta name="keywords" content="React, Project Structure, Architecture, Atomic Design" />
            <meta property="og:title" content="Project Structure &#8729; React Starter" />
            <meta property="og:description" content="Folder organization and project architecture guide." />
